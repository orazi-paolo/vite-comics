...
<main class="container">
  <div class="row">
    <AppMainCurrentSeries v-for="(currentSeriesItem, index) in currentSeriesList"
    :key="index"
    :thumbImageUrl=  "currentSeriesItem.thumb" 
    :thumbPrice= "currentSeriesItem.price"
    :thumbSeries= "currentSeriesItem.series"
